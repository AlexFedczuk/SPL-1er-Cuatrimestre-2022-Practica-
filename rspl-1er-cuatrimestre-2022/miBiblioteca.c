...
void mostrarMenu(){
    printf("\nMenu pricipal\n");
    printf("1. Cargar archivo de Comics (PUNTO 1)\n");
    printf("2. Ordenar la lista de Comics (PUNTO 2)\n");
    printf("3. Mostrar la lista de Comics (PUNTO 3)\n");
    printf("4. Descontar el Poder de los Comics (PUNTO 4, ll_map)\n");
    printf("5. Guardar la nueva lista en un nuevo archivo (PUNTO 5)\n");
    printf("6. Salir\n");
}
